function varargout = AMathInputPanel(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @AMathInputPanel_OpeningFcn, ...
    'gui_OutputFcn',  @AMathInputPanel_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before AMathInputPanel is made visible.
function AMathInputPanel_OpeningFcn(hObject, eventdata, handles, varargin)
dbstop if error;
...
clc;
% Choose default command line output for AMathInputPanel
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes AMathInputPanel wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = AMathInputPanel_OutputFcn(hObject, eventdata, handles)
