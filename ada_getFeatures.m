...
%% mode the stroke with left to right; 
% adjusted for the MathInputPanel
for sss = 1:strokeNum;
    currentStroke = pointMtx(:,:,sss);
    leftX(sss,1) = (currentStroke(1,1));
end
...
for sn = 1: strokeNum;
    sss = ind(sn,1);
    totalPointMtx = [totalPointMtx ; pointMtx(:,1:2,sss)];
